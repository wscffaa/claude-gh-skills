...
用法:
    python3 get_project_issues.py --project 1 [--owner OWNER] [--json]

示例:
    python3 get_project_issues.py --project 2 --owner "@me" --json
...
def main():
    ...
    parser.add_argument("--owner", help="仓库/组织 owner（默认从当前仓库推断）")
