...
Project URL: https://github.com/users/wscffaa/projects/1
```
...
{
  "projects": [
    {"number": 1, "title": "BasicOFR v1.0 Release", "id": "PVT_xxx", "url": "..."}
  ],
  "options": {
    "new_project_index": 2,
    "skip_index": 3
...
创建新 GitHub Project 并初始化 5 个状态列。
...
```json
{
  ...
  "id": "PVT_xxx",
  "title": "Sprint 1",
  "url": "https://github.com/users/wscffaa/projects/2"
}
```
